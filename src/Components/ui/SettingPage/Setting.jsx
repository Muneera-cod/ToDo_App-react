...
import LoadingPage from "../../Pages/LoadingPage"; // Ensure you have this component
    ...
    <>
      ...
      <div className="flex flex-col w-full sm:px-2 md:px-12 py-10 max-w-full overflow-hidden">
        ...
        <div className="flex w-full sm:flex-col md:flex-row sm:text-sm md:text-md font-[700] gap-6 md:items-center border-b-2 py-2 pt-6 border-lightModelightBg dark:border-lightBgclr">
          ...
          <button onClick={handleUpdate} className="dark:bg-lightBgclr bg-lightModelightBg py-2 px-4 rounded-md dark:border-markclr border-lightModelightBg border-[0.5px]">{`${firstName ? 'Update' : 'Add'}`}</button>
        </div>
        ...
        <div className="flex w-full sm:flex-col md:flex-row sm:text-sm md:text-md font-[700] gap-6 md:items-center border-b-2 py-2 pt-6 border-lightModelightBg dark:border-lightBgclr">
          ...
          <button onClick={handleUpdate} className="dark:bg-lightBgclr bg-lightModelightBg py-2 px-4 rounded-md dark:border-markclr border-lightModelightBg border-[0.5px]">{`${lastName ? 'Update' : 'Add'}`}</button>
        </div>
        ...
        <div className="flex w-full sm:flex-col md:flex-row sm:text-sm md:text-md font-[700] gap-6 md:items-center border-b-2 py-2 sm:pt-16 lg:pt-32 border-lightModelightBg dark:border-lightBgclr">
          ...
          <button onClick={handleUpdate} className="dark:bg-lightBgclr bg-lightModelightBg py-2 px-4 rounded-md dark:border-markclr border-lightModelightBg border-[0.5px]">{`${email ? 'Update' : 'Add'}`}</button>
        </div>
        ...
        <div className="flex w-full sm:flex-col xl:flex-row sm:text-sm md:text-md font-[700] gap-6 border-b-2 py-2 sm:pt-16 lg:pt-32 border-lightModelightBg dark:border-lightBgclr">
          ...
          <button onClick={handleUpdate} className="sm:w-full md:w-fit dark:bg-lightBgclr bg-lightModelightBg py-2 px-4 rounded-md dark:border-markclr border-lightModelightBg border-[0.5px]">Update</button>
        </div>
