...
function ProfilePage() {
  ...
  return (
    <>
      ...
      { user && todos && <><p onClick={()=>navigate('/')} className="mr-auto font-[700] text-sm opacity-40 hover:opacity-100 text-lightmodemainTextclr dark:text-darkmainTextclr  z-20 ">back</p>
     <TopPart user={user}/>
