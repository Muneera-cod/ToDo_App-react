...
function LandinPage() {
  ...
  <main className="min-h-screen gap-6 flex flex-col justify-center items-center sm:p-2   md:p-14 lg:p-20">
    <div className="pt-12 justify-end items-center  flex flex-col gap-4 w-full dark:bg-mainBgclr gap-4 bg-lightModeMainBg  text-lightmodemainTextclr dark:text-darkmainTextclr ">
        ...
        <hr className="my-4 w-full h-2 rounded-full sm:w-[calc(100vw-200px)] md:w-1/2 xl:w-2/5 dark:opacity-20 border-0  dark:bg-markclr bg-lightModelightBg"/>
